...
void setup () {
  ...
  //gif images 
  //fireball
  images[0] = loadImage("gif1.jpg");
  images[1] = loadImage("gif2.jpg");
  images[2] = loadImage("gif3.jpg");
  images[3] = loadImage("gif4.jpg");
  images[4] = loadImage("gif5.jpg");
  images[5] = loadImage("gif6.jpg");
  images[6] = loadImage("gif7.jpg");
  images[7] = loadImage("gif8.jpg");
  images[8] = loadImage("gif9.jpg");
  images[9] = loadImage("gif10.jpg");
  images[10] = loadImage("gif11.jpg");
  images[11] = loadImage("gif12.jpg");
  images[12] = loadImage("gif13.jpg");
  images[13] = loadImage("gif14.jpg");
  images[14] = loadImage("gif15.jpg");
  images[15] = loadImage("gif16.jpg");
  images[16] = loadImage("gif17.jpg");
  //rainbow star
  //space images
